...
namespace MiniIDEv04.ViewModels
{
    public partial class ProjectViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private string _titleDisplay  = "MiniIDE — MiniIDEv04";
        ...
        public async Task InitializeAsync()
        {
            ...
            var projectRoot = await _settings.GetValueAsync("ProjectRootPath");
            TitleDisplay = string.IsNullOrWhiteSpace(projectRoot)
                ? $"MiniIDE — {AppVersion}"
                : $"MiniIDE — {AppVersion}  |  {projectRoot}";
