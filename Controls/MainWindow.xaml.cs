...
namespace MiniIDEv04.Views
{
    public partial class MainWindow : Window
    {
        ...
        // ── ProjectZip panel clicked — toggle the embedded ucProjectZip ──────
        private void Panel_ZipClicked(object? sender, EventArgs e)
        {
            // The ProjectZipLauncherControl is self-contained — ucProjectZip
            // lives inside it and handles the zip operation directly.
            // Nothing to do here at the MainWindow level; hook is present
            // so future behaviours (e.g. status bar update) can be added.
            _vm.StatusMessage = "🗜  Project Zip — use the panel button to zip.";
        }
